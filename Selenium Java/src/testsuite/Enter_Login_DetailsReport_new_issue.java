...
/** Conformiq generated test case
	Enter_Login_DetailsReport_new_issue
*/
public class Enter_Login_DetailsReport_new_issue extends PageObjectBase
{

	public Enter_Login_DetailsReport_new_issue()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Enter_Login_DetailsReport_new_issue", "TC_Enter_Login_DetailsReport_new_issue", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_7");

	Reporter.log("Step - 8- Select Report Issuse Button clickchoice Mantis Home screen Mantis Navbar menubar Report menu");

	testReport.fillTableStep("Step 8", "Select Report Issuse Button clickchoice Mantis Home screen Mantis Navbar menubar Report menu");

	mantis_home_page_init.click_Report_Issuse_Button();
	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_8");
	...
	report_issue_page_init.verify_Upload_Files_Status(Step_9_Upload_Files_HYPERLINK_Status);

	report_issue_page_init.verify_Existing_tags_Status(Step_9_Existing_tags_DROPDOWN_Status);

	report_issue_page_init.verify_Existing_tags(Step_9_Existing_tags_DROPDOWN_Verification);
	report_issue_page_init.verify_View_Status(Step_9_View_Status_RADIOBUTTONGROUP_Verification);

	report_issue_page_init.verify_View_Status_public_Status(Step_9_public_RADIOBUTTON_Status);

	report_issue_page_init.verify_View_Status_private_Status(Step_9_private_RADIOBUTTON_Status);

	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_9");
	...
	report_issue_page_init.select_Existing_tags(Step_10_Existing_tags_DROPDOWN);
	report_issue_page_init.select_View_Status_Step_10_View_Status_RADIOBUTTONGROUP);

	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Enter_Login_DetailsReport_new_issue","Step_11");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Enter_Login_DetailsReport_new_issue");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
