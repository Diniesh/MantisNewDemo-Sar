...
/** Conformiq generated test case
	EmptyUsername
*/
public class EmptyUsername extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "EmptyUsername", "TC_EmptyUsername", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "EmptyUsername","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "EmptyUsername","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "EmptyUsername","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "EmptyUsername","Step_5");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "EmptyUsername");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
