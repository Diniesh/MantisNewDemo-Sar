...
/** Conformiq generated test case
	Invalidpassword
*/
public class Invalidpassword extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Invalidpassword", "TC_Invalidpassword", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Invalidpassword","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Invalidpassword","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Invalidpassword","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Invalidpassword","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Invalidpassword","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Invalidpassword","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Invalidpassword","Step_8");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Invalidpassword");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
