...
creator.gui.screen qmlbde0e62e89444a69a4c4216339834a4b "Login Screen"
{
	...
	annotations=["selenium:XPATH" = "//p[contains(text(),'Your account may be disabled or blocked or the use')]";]
		status = dontcare;
	creator.gui.hyperlink qml95ac638cdcc54df7aa3994ce755776dc
	"Sign up for a new account"
	annotations = ["selenium:XPATH" = "//a[contains(text(),'Signup for a new account')]";]
		status = dontcare;
}
