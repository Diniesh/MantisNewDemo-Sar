...
/** Conformiq generated test case
	Login_screen_with_username_inputs
*/
public class Login_screen_with_username_inputs extends PageObjectBase
{

	public Login_screen_with_username_inputs()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Login_screen_with_username_inputs", "TC_Login_screen_with_username_inputs", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs","Step_6");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Login_screen_with_username_inputs");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
