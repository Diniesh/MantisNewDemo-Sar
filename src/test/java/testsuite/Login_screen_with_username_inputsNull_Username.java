...
/** Conformiq generated test case
	Login_screen_with_username_inputsNull_Username
*/
public class Login_screen_with_username_inputsNull_Username extends PageObjectBase
{

	public Login_screen_with_username_inputsNull_Username()
	{
	}
	...
	public void test(final String Step_1_URL_FIELD, final String Step_3_username_textbox_TEXTBOX, final String Step_5_Empty_username_error_message_label_LABEL_Verification) throws Exception
	...
	testReport.generateGeneralInfo(overallTestData, "Login_screen_with_username_inputsNull_Username", "TC_Login_screen_with_username_inputsNull_Username", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputsNull_Username","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputsNull_Username","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputsNull_Username","Step_4");

	Reporter.log("Step - 5- verify Login Screen screen");

	testReport.fillTableStep("Step 5", "verify Login Screen screen");

	login_screen_page_init.verify_Empty_username_error_message_label(Step_5_Empty_username_error_message_label_LABEL_Verification);
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputsNull_Username","Step_5");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Login_screen_with_username_inputsNull_Username");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
