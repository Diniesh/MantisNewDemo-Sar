...
/** Conformiq generated test case
	Login_screen_with_username_inputs__2_
*/
public class Login_screen_with_username_inputs__2_ extends PageObjectBase
{

	public Login_screen_with_username_inputs__2_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Login_screen_with_username_inputs__2_", "TC_Login_screen_with_username_inputs__2_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs__2_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs__2_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs__2_","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs__2_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Login_screen_with_username_inputs__2_","Step_6");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Login_screen_with_username_inputs__2_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
