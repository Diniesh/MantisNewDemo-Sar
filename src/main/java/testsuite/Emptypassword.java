...
/** Conformiq generated test case
	Emptypassword
*/
public class Emptypassword extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "Emptypassword", "TC_Emptypassword", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Emptypassword","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Emptypassword","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Emptypassword","Step_4");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Emptypassword","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Emptypassword","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Emptypassword","Step_7");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Emptypassword","Step_8");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Emptypassword");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
